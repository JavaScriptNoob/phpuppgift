...
<div class="code">
    ...
    if (!empty($_GET['length']) && !empty($_GET['width'])) {
        ...
        function calculateCircumference($l, $w)
        {
            ...
            echo   "<br>Arean lika med ".calculateArea($l,$w)."<br><br>";
            //  Utskrift av area  körs utanför funktion calculateArea som det står i uppgift
            return  (2 * ($l + $w));
        }

        echo "Omkretsen lika med ".calculateCircumference($length, $width);

    }else{
        echo "<br> type in values";
    }
